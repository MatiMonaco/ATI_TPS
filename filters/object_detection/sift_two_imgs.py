...
matched_img = cv2.drawMatches(img1, keypoints_1, img2, keypoints_2, matches[int(len(matches)/2):], img2, flags=2)
...
cv2.imwrite("bad_matched_images.jpg", matched_img)
